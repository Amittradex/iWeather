...
class WeatherManager {
    func getCurrentWeather(latitude: CLLocationDegrees, logitude: CLLocationDegrees) async throws -> ResponseBody {
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/weather?lat=\(latitude)&lon=\(logitude)&appid=\("4c25d9409e69fe9810fcaf3d12a4144d")&units=metric") else { fatalError("Missing URL")}
